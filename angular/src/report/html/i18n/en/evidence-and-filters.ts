...
export const enEvidenceAndFilters: Pick<Translations, "evidence" | "evidenceUnits" | "architectureSmells" | "familyNames" | "featurePatterns" | "filters"> = {
  ...
  filters: {
    ...
    compareFilterHelper: "Compare filters apply to component rows when a baseline is selected on this page.",
    compareFilterDisabledHint: "Select a baseline to enable component compare filters.",
    snapshotCompareModalTitle: "Compare with previous snapshot",
    snapshotCompareModalHelper: "Choose a stored snapshot to compare this run against.",
    componentsCompareCta: "Compare components with a previous snapshot",
