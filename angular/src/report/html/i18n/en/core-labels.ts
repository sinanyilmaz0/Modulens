...
export const enCoreLabels: Pick<Translations, "hero" | "impact" | "refactorEffort" | "scores" | "issues" | "issueExplanations" | "severity" | "priority" | "effort" | "actions" | "empty"> = {
  ...
  empty: {
    ...
    noCompareFilterHint: "Try “All (compare)”, adjust filters, or change the baseline on the project card.",
    noComparedComponentsFilter: "No compared rows match this filter.",
    noCompareProjectScope: "No rows in the active compare project match the current filters.",
    selectBaselineForCompare: "Pick a baseline snapshot on a project card to use compare filters.",
    selectBaselineEnableCompare: "Pick a baseline snapshot on Overview to turn on compare mode.",
