...
test("renderHtmlReport embeds __SNAPSHOT_HISTORY__ and compare UI hooks", () => {
  ...
  assert.ok(html.includes("project-compare-btn"));
  assert.ok(html.includes("data-project-compare"));
  assert.ok(html.includes("data-project-compare-diff"));
  assert.ok(html.includes("components-explorer-baseline-bar"));
  assert.ok(html.includes("project-compare-detail-modal"));
  assert.ok(html.includes("project-compare-detail-modal-subtitle"));
  assert.ok(html.includes("project-compare-detail-modal-head-text"));
  assert.ok(html.includes("Differences between the selected baseline"));
  assert.ok(html.includes("data-project-compare-toggle-details"));
});
